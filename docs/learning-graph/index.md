# Learning Graph for Learning Record Store
...
This graph has **578 concepts** and **871 dependency edges**, organized in three
parts — standards foundations, this project's own specification and design, and
the three personas who use the finished system — and grouped into 15 taxonomy
categories. Here are the other files used by the learning graph.
...
into a single primary classifier. This graph uses 15 categories rather than
the usual ~12, since the book spans three very different domains (standards,
systems design, and operational practice).

- A concept classifier taxonomy with 15 categories
- Category organization - foundational elements first, persona practice last
- Balanced categories (1.0% - 12.5% each)
...
[View the Mascot Test Page](mascot-test.md)
